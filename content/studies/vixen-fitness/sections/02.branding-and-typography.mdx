...
import { montserrat } from '@/fonts/studies/vixen-fitness'
  ...
  logos: [
    {
      ...
      sizes: '(min-width: 64em) 25vw, 100vw'
    },
    {
      image: logoYellow,
  ...
  postcards: [
    {
      ...
      sizes: '(min-width: 28em) 40em, 70vw'
    },
    {
      image: postcardTwo,
  ...
  collateral: [
    {
      ...
      sizes: '(min-width: 64em) 32em, 100vw'
    },
    {
      image: placeCards,
...
<TypeSample fontName="Have Heart One" fontClass={haveHeart.className} sourceWords={sourceWords} style={{ fontSize: '8vw', lineHeight: '1em' }} />
