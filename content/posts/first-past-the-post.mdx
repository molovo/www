export const metadata = {
  ...
  description: "How I spent two years building a Medium-like platform called The Branch, only to abandon it when Medium launched. A cautionary tale about perfectionism, procrastination, and why you should just ship it.",
  tags: ['design', 'process']
}
