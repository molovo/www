export const metadata = {
  ...
  description: 'How storytelling principles can improve web design and user experience. Creating compelling narratives through digital interfaces and user journeys.',
  tags: ['design', 'web'],
}
