export const metadata = {
  ...
  description: 'Why there are no examples of my work on this site. A candid look at the struggle to write compelling case studies and the perfectionism that holds us back.',
