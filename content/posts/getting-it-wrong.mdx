...
export const metadata = {
  ...
  description: 'A heartfelt apology to users with accessibility needs. How I failed at web accessibility and the steps I took to fix my mistakes and do better.',
