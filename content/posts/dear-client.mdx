export const metadata = {
  date: '2014-01-10',
  title: 'Dear Client',
  description: 'An open letter to web design clients about collaboration, expectations, and building successful creative partnerships. Insights from a freelance web developer.',
  tags: ['freelancing']
}
