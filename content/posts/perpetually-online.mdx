...
import opengraphImage from '@/images/articles/perpetually-online/opengraph-image.jpg'

export const metadata = {
  title: 'Perpetually Online',
  titleSwashCharacter: ' ',
  description: 'Exploring the challenges of constant connectivity and maintaining healthy boundaries in our always-online world. Tips for digital wellness and work-life balance.',
  date: '2025-06-05',
  headerStyle: 'red',
  image: laptop,

  opengraphImage,
  opengraphImageAlt: 'A sketched image of a man sat at a laptop. The moon is shown above him. The words "Perpetually Online" are written across the image in large red font.',
