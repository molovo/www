...
export const metadata = {
  ...
  description:
    "Longing for the days when photos sparked imagination, not like today's fleeting digital images. Can we steer technology towards enhancing life rather than providing distractions?",
  tags: ['inspiration', 'opinion'],
  categories: ['featured'],
  order: 1,
  image,
  imageAlt: 'A man&rsquo;s feet, looking down from the top of a building',
  imageSizes: '100vw',
  imageFullSize: true,
  headerStyle: 'white',
}
