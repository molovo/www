...
export const metadata = {
  ...
  description: 'I long for the days when photos sparked imagination, not like today’s fleeting digital images. Can we aim to steer technology towards enhancing life, rather than just providing more online distractions?',
...
<ContentImage src={forthVean} alt="A satellite image of the street where I grew up." caption="A satellite image of the street where I grew up." size="standard" />
