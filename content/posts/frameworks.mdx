export const metadata = {
  date: '2012-12-10',
  title: 'Frameworks',
  description: "Thoughts on web development frameworks, when to use them, and when to build from scratch. A developer's perspective on framework selection in 2012.",
