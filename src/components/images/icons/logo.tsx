...
const Logo = ({
  ...
  >
    ...
    />
    <path
      className={leftLensClassName}
      d="M41.059,16.797c-2.733,8.065-7.017,13.918-18.021,14.213 c-10.899,0-14.066-1.986-15.513-14.678c0-8.515-0.558-13.5,15.606-13.47C34.03,3.908,45.462,3.804,41.059,16.797z"
      fill="transparent"
    />
    <path
      className={rightLensClassName}
      d="M92.615,16.333 c-1.447,12.691-4.613,14.678-15.514,14.678c-11.004-0.295-15.288-6.148-18.021-14.213C54.678,3.804,66.109,3.908,77.009,2.863 C93.172,2.833,92.615,7.818,92.615,16.333z"
      fill="transparent"
    />
  </svg>
)
